...
//------------
    console.log('ts', chalk.yellowBright(options.appendTsSuffixTo))
    console.log('tsx', chalk.yellowBright(options.appendTsxSuffixTo))
    console.log(util.inspect(this.query))
    console.log(chalk.italic.greenBright(this.resourcePath))
//------------
...
function successLoader(loader, contents, callback, options, instance) {
    ...
    if (rawFilePath.match(/\.vue$/)) debugger
...
function getLoaderOptions(loader) {
    ...
    if (utils_1.hasOwnProperty(loaderOptionsCache, instanceName)) {
        console.log(loaderOptions.appendTsSuffixTo, loaderOptions.appendTsxSuffixTo)
    ...
    loaderOptions = {appendTsxSuffixTo: [/\.tsx\.vue$/]}
    var options = makeLoaderOptions(instanceName, configFileOptions, loaderOptions);
    loaderOptionsCache[instanceName] = options;
    console.log(chalk.underline.greenBright('cfg', util.inspect(configFileOptions)))
    console.log(chalk.underline.greenBright('ldo', util.inspect(loaderOptions)))
    return options;
}
...
function getEmit(rawFilePath, filePath, instance, loader) {
    ...
    var outputText = (outputFile) ? outputFile.text : undefined;console.log(outputText)
